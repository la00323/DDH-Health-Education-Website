...
export type Ratio = "16/9" | "4/3" | "21/9" | "1/1";
...
export const imageSlots: ImageSlot[] = [
  ...
  },
  {
    ...
    ratio: "16/9",
    alt: "髖關節超音波檢查進行中",
    caption: "寶寶側躺，髖關節微彎，探頭貼在大腿外側。全程約三到五分鐘。",
    source: "C-026 / C-027",
  },
  ...
  {
    id: "timeline-4-6w",
    brief: "時間軸：出生 → 4–6 週（建議檢查）→ 一個月後追蹤。0–4 週那段標為「太早，偽陽性高」",
    ratio: "21/9",
    alt: "髖關節超音波的建議時間軸",
    caption: "出生後四週內關節本來就鬆，太早照會有很高的偽陽性。",
    source: "B-005 / C-003",
  },
  {
    id: "risk-factors",
